...
export function enquiryReceivedAdminTemplate(data: {
  ...
  return {
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:640px;margin:0 auto;padding:24px;background:#F6F5FC;color:#0B0F1F;">
        <div style="background:linear-gradient(135deg,#7C3AED,#0B0F1F);padding:24px;border-radius:20px;color:#fff;">
        ...
        <div style="background:#fff;border-radius:20px;padding:24px;margin-top:16px;border:1px solid #E3DEF7;">
          ...
          <div style="margin-top:18px;padding:16px;border-radius:16px;background:#F1EBFE;border:1px solid #E3DEF7;">
            <div style="font-size:12px;letter-spacing:.12em;text-transform:uppercase;color:#7C3AED;font-weight:700;">Client message</div>
...
export function enquiryReceivedCustomerTemplate(data: { fullName: string }) {
  return {
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:640px;margin:0 auto;padding:24px;background:#F6F5FC;color:#0B0F1F;">
        <div style="background:linear-gradient(135deg,#7C3AED,#9061F9);padding:28px;border-radius:24px;color:#fff;">
...
export function enquiryStatusTemplate(data: { fullName: string; status: string; notes?: string | null }) {
  return {
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:640px;margin:0 auto;padding:24px;background:#F6F5FC;color:#0B0F1F;">
        <div style="background:linear-gradient(135deg,#0B0F1F,#7C3AED);padding:24px;border-radius:20px;color:#fff;">
          <div style="font-size:12px;letter-spacing:.18em;text-transform:uppercase;opacity:.85;">Cape Compass</div>
